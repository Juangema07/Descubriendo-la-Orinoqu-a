...
const makeImage=(src,alt)=>{const img=document.createElement('img');img.src=src;img.alt=alt;img.loading='lazy';img.decoding='async';img.addEventListener('error',()=>{img.classList.add('image-failed');img.alt=`Imagen no disponible: ${alt}`},{once:true});return img};
...
[W+'1/16/Mapa_de_Colombia_%28regi%C3%B3n_de_la_Orinoqu%C3%ADa%29.svg','Mapa de la región natural de la Orinoquía','Ubicación','La región se localiza al oriente de Colombia y está relacionada con la cuenca del Orinoco.'],
[W+'7/79/Yopal-Casanare.jpg','Vista de Yopal, Casanare','Casanare','Una ciudad que funciona como centro urbano y de servicios del departamento.'],
[W+'5/59/Cerro_La_Bandera%2C_Puerto_Carre%C3%B1o_-_panoramio.jpg','Cerro La Bandera en Puerto Carreño','Vichada','Desde este sector se aprecia el paisaje urbano y parte del entorno del río Orinoco.']
]);
addGallery('#naturaleza','Paisajes diferentes dentro de una misma región',[
[W+'8/8d/Cuenca_Rio_Cravo_Sur.jpg','Cuenca del río Cravo Sur','Ríos y relieve','Los cursos de agua ayudan a explicar cómo se organiza el paisaje.'],
[W+'f/f7/Perdidos_en_la_sabana.jpg','Paisaje de sabana','Sabana','Las sabanas son uno de los ambientes más representativos de los Llanos.'],
[W+'0/0b/Boa_constrictor_aliada_en_el_equilibrio_ecosistemico.jpg','Boa constrictor en la Orinoquía','Fauna','La fauna también hace parte de la dinámica de estos ecosistemas.']
]);
addGallery('#biodiversidad','Fauna y flora para mirar con otros ojos',[
[W+'7/7b/Curiosidad_en_el_Dosel%2C_Mono_Maicero_de_la_Orinoqu%C3%ADa.png','Mono maicero de la Orinoquía','Mamíferos','Los bosques y corredores de vegetación ofrecen refugio y alimento a distintas especies.'],
[W+'e/e7/Melanerpes_cruentatus_Little_Woodpecker.png','Carpinterito de la Orinoquía','Aves','Las aves permiten observar la variedad de ambientes presentes en la región.'],
[W+'2/2a/Racimo_de_la_palmera_corneto.jpg','Racimo de palmera corneto','Flora','Las plantas también son parte clave de las redes ecológicas del territorio.']
]);
addGallery('#gente','Personas, ciudades y formas de conectar el territorio',[
[W+'e/e7/Navegabilidad_por_el_R%C3%ADo_Meta.jpg','Navegación por el río Meta','Conectividad','El transporte fluvial puede ser importante para conectar comunidades y actividades.'],
[W+'2/21/Calle_principal_de_Puerto_Carre%C3%B1o_-_panoramio.jpg','Calle principal de Puerto Carreño','Vida urbana','La vida urbana también hace parte de la diversidad territorial de la Orinoquía.'],
[W+'8/84/Panam%C3%A1_de_Arauca%2C_Arauquita-Col.jpg','Panamá de Arauca, Arauquita','Arauca','Una muestra del territorio del departamento de Arauca.']
]);
addGallery('#cultura','Imágenes de la identidad llanera',[
[W+'e/1/Bailando_Joropo.jpg','Personas bailando joropo','Joropo','Música y danza son expresiones centrales de la cultura llanera.'],
[W+'d/f/JOROPO.jpg','Baile de joropo','Tradición viva','Las expresiones culturales se mantienen, se enseñan y también evolucionan.'],
[W+'b/b4/Alphons_St%C3%BCbel_llanero_de_Casanare.png','Llanero de Casanare, registro histórico','Memoria','Las imágenes históricas también ayudan a conocer cómo se ha representado la vida llanera.']
]);
addGallery('#economia','Producción, agricultura y territorio',[
[W+'9/9b/Llanos_Orientales_-_Arroz.jpg','Arroz en los Llanos Orientales','Agricultura','Los cultivos forman parte de la actividad agropecuaria de la región.'],
[W+'8/84/Hacienda_de_Cumaral.jpg','Hacienda de Cumaral','Actividad rural','Las haciendas y espacios rurales muestran otra dimensión del paisaje productivo.'],
[W+'1/10/Los_Llanos_Colombia_by_David.png','Paisaje de Los Llanos','Territorio productivo','El paisaje rural permite observar cómo se relacionan producción, espacio y naturaleza.']
]);
addGallery('#retos','Cambios del territorio que vale la pena observar',[
[W+'0/02/%22Bajo%22_llanura_inundada_en_La_Primavera%2C_Vichada.jpg','Llanura inundada en Vichada','Agua','Las temporadas húmedas cambian temporalmente la apariencia y dinámica del paisaje.'],
[W+'8/8d/Morichal_en_La_Primavera%2C_Vichada.jpg','Morichal en La Primavera','Ecosistemas','Los ambientes asociados al agua necesitan manejo y conservación.'],
[W+'b/b2/NP_Llanos27_lo_%285853938480%29.jpg','Paisaje de los Llanos','Transformación','Mirar el paisaje permite conversar sobre los cambios que producen las actividades humanas y naturales.']
]);
addGallery('.parks','Áreas naturales y paisajes protegidos',[
[W+'8/0/TuparroNPP_banner.jpg','Paisaje de El Tuparro','El Tuparro','Un área protegida del Vichada de gran importancia natural.'],
[W+'f/f9/PNN_Sierra_de_la_Macarena.jpg','Sierra de La Macarena','Meta','Un territorio de gran diversidad ambiental y paisajística.']
]);
